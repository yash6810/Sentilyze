...
def test_beneish_m_score():
    ...
    res_pristine = calculate_beneish_m_score("NVDA", dsri=1.01, gmi=0.98, aqi=0.92, sgi=1.10, depi=1.00, sgai=0.95, lvgi=0.90, tata=0.01)
    ...
    res_red = calculate_beneish_m_score("ENRON", dsri=2.5, gmi=1.8, aqi=2.0, sgi=2.5, depi=1.5, sgai=1.2, lvgi=1.8, tata=0.35)
